               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     <select class="form-control" name="language" id="Language">
                        <option value="<?php echo e(App\Setting::get_option('language')); ?>"><?php echo e(App\Setting::get_option('language')); ?></option>
